...
export default function NewPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="text-[7svw] tracking-wider">{t.teamTitle}</div>
        <div className="font-normal text-[3.5svw] leading-[6.5svw] mt-[5svh] text-center">
          {t.teamMembers.map((member, index) => (
            <div key={index}>{member}</div>
          ))}
          <div className="font-semibold mt-[8svh] mb-[2svh]">
            {t.collaborationWith}
          </div>
